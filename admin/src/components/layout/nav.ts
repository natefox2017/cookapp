...
export const navItems: NavItem[] = [
  ...
  { title: 'Collections', href: '/collections', icon: Library, apiStatus: 'live' },
  { title: 'Ingredients', href: '/ingredients', icon: Carrot, apiStatus: 'live' },
  { title: 'Grocery', href: '/grocery', icon: ShoppingCart, apiStatus: 'live' },
  { title: 'Meal Plans', href: '/meal-plans', icon: CalendarDays, apiStatus: 'live' },
  { title: 'Pantry', href: '/pantry', icon: Refrigerator, apiStatus: 'live' },
