...
† Ops catalog pages (Recipes / Ingredients / Categories + Settings persist) are live via `admin-catalog` (#92). End-user Collections / Grocery / Meal Plan / Pantry have live APIs but are **not** Admin nav (#98). AI Import / Analytics / Ops / Payments / AI Platform **nav pages** remain Gate-deferred until Owner lifts Stage 4.
